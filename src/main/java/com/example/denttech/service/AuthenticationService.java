...
import com.example.denttech.model.Token;
import com.example.denttech.model.TokenType;
import com.example.denttech.model.User;
import com.example.denttech.repository.TokenRepository;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    var user = User.builder()
                   ...
                   .userRole(userRoleRepository.findById(request.getRole()).orElseThrow())
                   .build();
